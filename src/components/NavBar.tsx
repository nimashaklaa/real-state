export default function NavBar() {
  ...
  return (
    <nav className="absolute h-[90px] top-[34px] left-[30px] right-[30px] flex items-center justify-between px-4 py-2 bg-[#FAFAFA] text-gray-800 rounded-[70px]">
      <div className="flex flex-row items-center space-x-4">
        <img src={'img_6.png'} alt="logo" className="w-[93.89px] h-[27.5px]" />
        <div className="flex flex-row items-center gap-6 px-4 py-2 bg-[#FFFFFF] text-gray-800 rounded-[40px] h-[60px]">
